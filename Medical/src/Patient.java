...
public class Patient {
    ...
    public Patient(String patientName, String nationalID,Date DateOfBirth, String gender, String phoneNumber, String city, String occupation, String bloodGroup, boolean insured, ArrayList<Visit> visitList) {
    ...
    public Patient(String patientName, String nationalID,Date DateOfBirth, String gender, String phoneNumber, String city, String occupation, String bloodGroup, boolean insured) {
        PatientID = INC++;
    ...
    public void PatientInfo(){
        ...
        System.out.println("                                    =========================================================================================");
        System.out.println("---------------------------------------------------------------------------------------------------------------------------------------------------------------------");
        System.out.printf("| %-10s | %-15s | %-12s | %-30s | %-8s | %-12s | %-10s | %-12s | %-12s | %-10s |\n",
